  ...
  return (
    <>
      <motion.div variants={textVariant()} className="text-center mb-10">
        <p className="text-[#915eff] font-medium text-[18px] uppercase tracking-wider">Human Algorithm</p>
        <h2 className="text-white font-black md:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] mt-2">About Me.</h2>
      </motion.div>
